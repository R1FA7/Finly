...
export const ResetPasswordPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto shadow-md rounded-lg p-3">
          ...
          >
            ...
            {step === 1 && (
              <div className="mt-6 flex justify-end gap-4">
                <Button onClick={handleNext} disabled={btnLoadingMap.Next}>
                  {btnLoadingMap.Next ? <ButtonLoader text="Next" /> : "Next"}
                </Button>
              </div>
            )}
          </PasswordResetStepCard>
          ...
          >
            ...
            {step === 3 && (
              <div className="mt-6 flex justify-end gap-4">
                <Button onClick={handleBack}>Back</Button>
                <Button onClick={handleNext} disabled={btnLoadingMap.Next}>
                  {btnLoadingMap.Next ? <ButtonLoader text="Done" /> : "Done"}
                </Button>
              </div>
            )}
          </PasswordResetStepCard>
